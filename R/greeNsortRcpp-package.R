# greeNsort.Rcpp package documentation
# (c) 2019 Dr. Jens Oehlschlägel
# All rights reserved
# Created: 2019-10-27

#' greeNsort.Rcpp - greeNsort extensions implemented in C++ code
#'
...
#' @useDynLib greeNsort.Rcpp, .registration = TRUE
#' 
